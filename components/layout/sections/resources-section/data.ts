...
export const resources: ResourceLink[] = [
  ...
  },
  {
    ...
    text: 'Research America: Advocating for Science, Discovery and Innovation',
    ariaLabel:
      'Research America is an advocacy organization for medical research funding (opens in a new tab)',
  },
  {
    href: 'https://www.nih.gov/about-nih/what-we-do/nih-almanac/chronology-events',
    text: 'NIH Historical Timeline',
    ariaLabel:
      'Timeline from NIH on medical history in the US and their impact since their founding (opens in a new tab)',
  },
]
