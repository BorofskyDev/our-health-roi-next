    ...
    <Page>
      <FlexColSection id='main'>
        ...
        <BodyText className='mb-24'>
          ...
          isn&apos;t truly functional unless it&apos;s fully accessible to everyone,
          regardless of ability or disability. Our goal is to ensure that every
          visitor can access the vital health funding information we provide and
          use it to participate in our democratic process.
        </BodyText>
        <ColToRowContainer>
          <FlexColContainer>
            ...
            <BodyText>
              ...
              technologies. We&apos;ve also included features like the &quot;Skip to
              Content&quot; link to improve navigation for screen reader users.
            </BodyText>
            <BodyText>
              Our commitment extends beyond technical compliance to embrace the
              spirit of inclusive design. We&apos;ve taken care to write in plain
              language, maintain consistent navigation patterns, and provide
              clear feedback for all interactive elements. Every piece of data
              visualization is designed with accessibility in mind, offering
              alternative ways to access the information beyond visual
        ...
        <ColToRowContainer>
          ...
          <FlexColContainer>
            ...
            <BodyText className='mb-24'>
              ...
              advocacy tools should be usable by everyone. This isn&apos;t just about
              meeting legal requirements—it&apos;s about living up to our values and
              respecting the dignity and rights of all visitors to our site.
            </BodyText>
          </FlexColContainer>
        </ColToRowContainer>
        <Heading as='h3' size='lg' className='mb-30'>
        ...
        <ColToRowContainer>
          <FlexColContainer>
            <BodyText>
              ...
              gaps or oversights in our implementation. These aren&apos;t intentional
              but stem from our own limitations and the evolving nature of web
              technologies. We view accessibility as a process of continuous
              improvement, and we&apos;re committed to learning and adapting.
            </BodyText>
            <BodyText>
              That&apos;s why we welcome your feedback. If you encounter any barriers
              while using Our Health ROI, please let us know. Your insights help
              us identify issues we might have missed and make the site better
              for everyone. We promise to take your feedback seriously and
              address issues promptly. After all, this is a citizen-built tool
              intended to serve all citizens—and your input is essential to
        ...
        <ColToRowContainer>
          ...
          <FlexColContainer>
            ...
            <BodyText className='mb-24'>
              Accessibility isn&apos;t just a technical requirement—it&apos;s a reflection
              of our values. We believe in digital equity and in removing
              barriers to civic participation. By making our site accessible,
              we&apos;re working to ensure that everyone has an equal opportunity to
              advocate for the health research funding that affects us all.
              Because a democracy works best when everyone can participate
              fully.
            </BodyText>
            <NavLink className='mb-44' href='/contact'>Contact us here</NavLink>
          </FlexColContainer>
        </ColToRowContainer>
        ...
        <BodyText>
          ...
          providing the best possible experience for all users. If you&apos;d like to
          contribute to our accessibility improvements, you can also check out
          our code on GitHub and submit pull requests.
        </BodyText>
        <ExternalLink
          className='mb-24'
